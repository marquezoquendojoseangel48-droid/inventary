...
var Project = class {
  ...
  listOAuth2Providers(paramsOrFirst, ...rest) {
    let params;
    if (!paramsOrFirst || paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateOAuth2Server(paramsOrFirst, ...rest) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
      params = {
        ...
        authorizationUrl: rest[0],
        scopes: rest[1],
        authorizationDetailsTypes: rest[2],
        accessTokenDuration: rest[3],
        refreshTokenDuration: rest[4],
        publicAccessTokenDuration: rest[5],
        publicRefreshTokenDuration: rest[6],
        installationAccessTokenDuration: rest[7],
        confidentialPkce: rest[8],
        verificationUrl: rest[9],
        userCodeLength: rest[10],
        userCodeFormat: rest[11],
        deviceCodeDuration: rest[12],
        defaultScopes: rest[13],
        installationScopes: rest[14]
      };
    }
    const enabled = params.enabled;
    ...
    if (typeof publicRefreshTokenDuration !== "undefined") {
      apiPayload["publicRefreshTokenDuration"] = publicRefreshTokenDuration;
    }
    if (typeof installationAccessTokenDuration !== "undefined") {
      apiPayload["installationAccessTokenDuration"] = installationAccessTokenDuration;
    }
  ...
  updateOAuth2Appwrite(paramsOrFirst, ...rest) {
    let params;
    if (!paramsOrFirst || paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateOAuth2Cloudflare(paramsOrFirst, ...rest) {
    let params;
    if (!paramsOrFirst || paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateOAuth2HuggingFace(paramsOrFirst, ...rest) {
    let params;
    if (!paramsOrFirst || paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateOAuth2Resend(paramsOrFirst, ...rest) {
    let params;
    if (!paramsOrFirst || paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateDenyAliasedEmailPolicy(paramsOrFirst) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateDenyCorporateEmailPolicy(paramsOrFirst) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateDenyDisposableEmailPolicy(paramsOrFirst) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateDenyFreeEmailPolicy(paramsOrFirst) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateMFAFactorsPolicy(paramsOrFirst, ...rest) {
    let params;
    if (!paramsOrFirst || paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updatePasswordStrengthPolicy(paramsOrFirst, ...rest) {
    let params;
    if (!paramsOrFirst || paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
