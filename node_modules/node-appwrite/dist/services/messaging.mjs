...
var Messaging = class {
  ...
  createSesProvider(paramsOrFirst, ...rest) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateSesProvider(paramsOrFirst, ...rest) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  getSubscriber(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/messaging/topics/{topicId}/subscribers/{subscriberId}".replace("{topicId}", encodeURIComponent(String(topicId))).replace(
      "{subscriberId}",
