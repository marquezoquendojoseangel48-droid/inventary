...
var Functions = class {
  ...
  getDeployment(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/functions/{functionId}/deployments/{deploymentId}".replace("{functionId}", encodeURIComponent(String(functionId))).replace(
      "{deploymentId}",
  ...
  getDeploymentDownload(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/functions/{functionId}/deployments/{deploymentId}/download".replace("{functionId}", encodeURIComponent(String(functionId))).replace(
      "{deploymentId}",
      encodeURIComponent(String(deploymentId))
    );
    const apiPayload = {};
  ...
  updateDeploymentStatus(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/functions/{functionId}/deployments/{deploymentId}/status".replace("{functionId}", encodeURIComponent(String(functionId))).replace(
      "{deploymentId}",
      encodeURIComponent(String(deploymentId))
    );
    const apiPayload = {};
