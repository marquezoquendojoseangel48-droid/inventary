...
var Sites = class {
  ...
  getDeployment(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/sites/{siteId}/deployments/{deploymentId}".replace("{siteId}", encodeURIComponent(String(siteId))).replace(
      "{deploymentId}",
  ...
  getDeploymentDownload(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/sites/{siteId}/deployments/{deploymentId}/download".replace("{siteId}", encodeURIComponent(String(siteId))).replace(
      "{deploymentId}",
      encodeURIComponent(String(deploymentId))
    );
    const apiPayload = {};
  ...
  updateDeploymentStatus(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/sites/{siteId}/deployments/{deploymentId}/status".replace("{siteId}", encodeURIComponent(String(siteId))).replace(
      "{deploymentId}",
      encodeURIComponent(String(deploymentId))
    );
    const apiPayload = {};
