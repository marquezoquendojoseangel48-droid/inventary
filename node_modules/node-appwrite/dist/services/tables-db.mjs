...
var TablesDB = class {
  ...
  createOperations(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/tablesdb/transactions/{transactionId}/operations".replace(
      "{transactionId}",
      encodeURIComponent(String(transactionId))
    );
    const apiPayload = {};
  ...
  createCutover(paramsOrFirst, ...rest) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
    ...
    const apiPath = "/tablesdb/{databaseId}/migrations/{migrationId}/cutovers".replace("{databaseId}", encodeURIComponent(String(databaseId))).replace(
      "{migrationId}",
  ...
  createBigIntColumn(paramsOrFirst, ...rest) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
  ...
  updateBigIntColumn(paramsOrFirst, ...rest) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
