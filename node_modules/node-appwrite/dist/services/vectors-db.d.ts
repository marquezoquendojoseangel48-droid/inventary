...
import { VectorsDBIndexType } from '../enums/vectors-db-index-type.js';
...
declare class VectorsDB {
     ...
     * @returns {Promise<Models.DocumentList<Document>>}
     */
    createQuery<Document extends Models.Document = Models.DefaultDocument>(params: {
        databaseId: string;
        collectionId: string;
        queries?: string[];
        transactionId?: string;
