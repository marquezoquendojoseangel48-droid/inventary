...
class Mongo {
  ...
  get(paramsOrFirst) {
    ...
    const apiPath = "/mongo/{databaseId}".replace(
      "{databaseId}",
  ...
  listBackups(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/backups".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  listBackupPolicies(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/backups/policies".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  getBackupPolicy(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/backups/policies/{policyId}".replace("{databaseId}", encodeURIComponent(String(databaseId))).replace("{policyId}", encodeURIComponent(String(policyId)));
    const apiPayload = {};
    const uri = new URL(this.client.config.endpoint + apiPath);
    const apiHeaders = {
      "X-Appwrite-Project": this.client.config.project,
  ...
  updateBackupStorage(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/backups/storage".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  listBranches(paramsOrFirst) {
    ...
    const apiPath = "/mongo/{databaseId}/branches".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  updateCredentials(paramsOrFirst) {
    ...
    const apiPath = "/mongo/{databaseId}/credentials".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  createFailover(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/failovers".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  updateMaintenance(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/maintenance".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  createMigration(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/migrations".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  listOperations(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/operations".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  getPitr(paramsOrFirst) {
    ...
    const apiPath = "/mongo/{databaseId}/pitr".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  getReplicas(paramsOrFirst) {
    ...
    const apiPath = "/mongo/{databaseId}/replicas".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  listRestorations(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/restorations".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  getRestoration(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/restorations/{restorationId}".replace("{databaseId}", encodeURIComponent(String(databaseId))).replace(
      "{restorationId}",
  ...
  getStatus(paramsOrFirst) {
    ...
    const apiPath = "/mongo/{databaseId}/status".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
  ...
  createUpgrade(paramsOrFirst, ...rest) {
    ...
    const apiPath = "/mongo/{databaseId}/upgrades".replace(
      "{databaseId}",
      encodeURIComponent(String(databaseId))
    );
    const apiPayload = {};
